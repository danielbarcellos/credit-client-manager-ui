<template>
    <div class="container">
        <div class="footer-main"><p class="footer-main-title">{{ message }}</p><a
                href="https://github.com/danielbarcellos/credit-client-manager" target="_blank" class="footer-main-link">Github</a><a
                href="mailto:danielpoars@gmail.com" class="footer-main-link">Email</a><a
...
<script>
    ...
    export default {
        data(){
            return {
                message: 'SpringBoot 2.00 And Vue.js - v0.1',
            }
        },
        mounted (){
